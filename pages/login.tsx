	...
	return (
		<div className="flex bg-infobg h-screen bg-no-repeat bg-cover bg-center" >
			<div className=" bg-white dark:bg-gray-800 dark:bg-opacity-50 dark:backdrop-blur-lg w-11/12 sm:w-4/6 md:3/6 xl:w-5/12 mx-auto my-auto rounded-3xl p-6" 					>
				<div>
					<p className="font-bold text-2xl ">👋 Welcome to LYDIATE Connect</p>
					<p className="text-md text-gray-500 dark:text-gray-200">
						You'll need to login to LYDIATE Connect account to use this page
					</p>
				...
				<div className="w-full flex">
					<a className="pt-4 mx-auto  text-gray-400 hover:underline cursor-pointer hover:text-blue-600 transition " href="https://LYDIATE Connectblox.xyz"> © LYDIATE Connect 2022 </a>
				</div>
			</div>
		</div>
	);
